...
PKG_DEPENDS_TARGET="toolchain cairo wayland-protocols libpng libjpeg-turbo libwebp libxkbcommon jsoncpp zlib"
...
pre_configure_target() {
  export TARGET_LDFLAGS="-L${SYSROOT_PREFIX}/usr/lib -lm -lz"
}
